...
EOF
    ...
    jq -n --arg installVersion "[[GNS_CURRENT_VERSION]]" --arg hostname "$HOSTNAME" '{"installVersion":$installVersion|tonumber, "hostname":$hostname}' > "$MNT_DIR/etc/nixos/garuda-managed.json"
    fi
}
