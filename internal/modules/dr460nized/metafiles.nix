...
in
{
  ...
  home.file = lib.mkMerge (
    ...
    ++ (lib.optional (builtins.elem "fish" pkgnames) {
    ...
    ++ (lib.optional (builtins.elem "micro" pkgnames) {
    ...
    ++ (lib.optional (builtins.elem "libreoffice" pkgnames) {
      "${appdir}/startcenter.desktop".text = ''
        ...
        [Desktop Action Calc]
        Exec=${libreoffice-qt}/bin/soffice --calc
        Name=Calc

        [Desktop Action Draw]
        Exec=${libreoffice-qt}/bin/soffice --draw
        Name=Draw

        [Desktop Action Impress]
        Exec=${libreoffice-qt}/bin/soffice --impress
        Name=Impress

        [Desktop Action Math]
        Exec=${libreoffice-qt}/bin/soffice --math
        Name=Math

        [Desktop Action Writer]
        Exec=${libreoffice-qt}/bin/soffice --writer
        Name=Writer
