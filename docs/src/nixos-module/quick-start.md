...
You may also use any of the [Chaotic Nyx's](https://www.nyx.chaotic.cx/) module or home-manager options. Garuda Nix' `nixpkgs` input follows Nyx' `nyxpkgs-unstable` (which updates daily and shouldn't be overridden to profit from their binary cache).
