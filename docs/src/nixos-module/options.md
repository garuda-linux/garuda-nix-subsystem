...
Edition enabled inside the trial specialisation.

- **Type**: `one of "mokka", "dr460nized"`
- **Default**: `"mokka"`
- **Declared in**: `internal/modules/base/try.nix`
...
Trial user created inside the specialisation. Must not already exist on the host.
