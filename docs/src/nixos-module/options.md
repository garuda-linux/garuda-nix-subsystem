...
### `garuda.catppuccin.themePackage`
...
### `garuda.dr460nized.themePackage`

Plasma look-and-feel package (global theme, window decorations,
login screen) applied to the desktop.

- **Type**: `package`
- **Default**: `<derivation dr460nized-kde-theme-unstable-20260808125139-c69cc04>`
- **Example**: `<derivation breeze-6.7.5>`
...
### `garuda.mokka.themePackage`

Plasma look-and-feel package (global theme, window decorations,
login screen) applied to the desktop.

- **Type**: `package`
- **Default**: `<derivation mokka-kde-theme-unstable-20260809074459-227de23>`
- **Example**: `<derivation breeze-6.7.5>`
